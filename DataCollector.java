...
public class DataCollector {
    ...
    public DataCollector(int[] numOfTests) {
        ...
        File f = new File("dataCollector.xlsx");
        if(! f.exists()) {
            ...
            try {
                FileOutputStream outputStream = new FileOutputStream("dataCollector.xlsx");
    ...
    public void addTestGrade(int questionNum, int testNum, int grade, int studentNum, String expected) {
        try {
            FileInputStream inputStream = new FileInputStream(new File("dataCollector.xlsx"));
